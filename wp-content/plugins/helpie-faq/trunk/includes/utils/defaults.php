...
if (!class_exists('\HelpieFaq\Includes\Utils\Defaults')) {
    ...
    class Defaults
    {
        ...
        public function all_faq_page_demo_setup($category_term_id)
        {
            ...
            // 1. Create FAQ Posts
            $this->utils_helper->insert_post_with_term('helpie_faq', $category_term_id, 'helpie_faq_category', 'Simple FAQ', 'Simple FAQ Content');
            $this->utils_helper->insert_post_with_term('helpie_faq', $category_term_id, 'helpie_faq_category', 'Simple FAQ - 2', 'Simple FAQ Content - 2');
